...
def main(args):
    ...
    if 'all' in transfer_tasks: transfer_tasks=['MR', 'CR', 'MPQA', 'SUBJ', 'SST2', 'TREC', 'MRPC']
...
def get_args():
    ...
    parser.add_argument("--task",
                        nargs='+',
                        default=['MR'],#SST5?
                        choices=['MR', 'CR', 'MPQA', 'SUBJ', 'SST2', 'TREC', 'MRPC', 'all'],
                        help="example: python bert_transfer_learning.py --task MR CR. all for all 7 tasks."
                        )
